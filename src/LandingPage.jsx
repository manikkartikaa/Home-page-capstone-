      ...
      <div className="elegant-logo-4-crop-1"></div>
        ...
        <div className="group-230"> 
          <div className={`nav ${isNavbarFixed ? 'fixed' : ''}`}>
            ...
            <NavLink to="/LandingPage" className="home">Home</NavLink>
          <NavLink to="/RecommendationPageRevise" className="recommendation">Recommendation</NavLink>
          <NavLink to="/FurniturePageRevise" className="furniture">Furniture</NavLink>
          <NavLink to="/AboutUsPage" className="about">About</NavLink>
          </div>
        </div>
        <div className="nav-MobLP">
        <div className="clarityvmw-app-lineLP" onClick={() => setMenuOpen(!menuOpen)}>
        ...
        <div className="footer">
          ...
          <div className="container-7">
            ...
            <Link to="/AboutUsPage" className="about-us">About</Link>
